...
### 🔄 Recent Git Activity
- b2023d6 Updates Jest configuration for improved testing
- 25f5a7e Implements Stripe webhook handling and subscription management
...
M .cursor/sessions/context/session_20250921_093042_summary.md
 M __tests__/integration/api/user-profile.test.ts
 M __tests__/unit/components/Button.test.tsx
 M __tests__/unit/components/SubscriptionStatus.test.tsx
 M __tests__/unit/services/EmailService.test.ts
 M __tests__/unit/services/PDFService.test.ts
 M __tests__/unit/services/S3Service.test.ts
 M __tests__/utils/test-utils.ts
 M app/api/consent/route.ts
 M app/api/consent/withdraw/route.ts
 M app/api/user-data/update/route.ts
 ...
 M lib/security/securityMiddleware.ts
?? __tests__/security/csrf-protection.test.ts
?? __tests__/unit/api/user-profile-api.test.ts
?? __tests__/unit/components/UserProfile.test.tsx
?? __tests__/unit/services/stripeService.test.ts
