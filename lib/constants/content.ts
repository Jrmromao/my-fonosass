...
export const navigationItems = ['Recursos', 'Sobre', 'Preços', 'FAQ'];

export const features = [
  {
    title: 'Exercícios Personalizados',
    description:
      'Ampla variedade de exercícios adaptados para abordar questões específicas de desenvolvimento da linguagem.',
    icon: BookOpen,
  },
  {
...
export const footerLinks = [
  ...
  { title: 'Suporte', items: ['FAQ', 'Ajuda', 'Tutoriais', 'Contato'] },
