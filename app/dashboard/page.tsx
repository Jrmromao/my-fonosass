      ...
      <div className="px-6 pb-6">
        ...
        >
          ...
          <TabsContent value="overview" className="space-y-6">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Badge
                        variant="secondary"
                        className="bg-purple-100 text-purple-600 dark:bg-purple-900 dark:text-purple-400"
                      >
                        CH (4)
                      </Badge>
                      <Badge
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="border border-gray-100 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                    <Badge className="mb-2 bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-400">
                      Fonema R
                    </Badge>
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Atividade para praticar palavras com R em posição inicial
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">
                        5-7 anos
                  ...
                  <div className="border border-gray-100 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                    <Badge className="mb-2 bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400">
                      Fonema S
                    </Badge>
                    <h3 className="font-medium text-gray-900 dark:text-white mb-1">
                      Caça ao Tesouro
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Identificação de objetos com som S em posição medial
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">
                        4-6 anos
                  ...
                  <div className="border border-gray-100 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                    <Badge className="mb-2 bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400">
                      Fonema L
                    </Badge>
                    <h3 className="font-medium text-gray-900 dark:text-white mb-1">
                      História Interativa
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Narrativa com foco em palavras com L em posição inicial
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">
                        6-8 anos
            ...
            {/* Voice Demo Widget */}
            <VoiceDemo className="bg-white dark:bg-gray-800" />
          </TabsContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  {patients.map((patient) => (
                    <div
                      key={patient.id}
                      className="flex items-center justify-between p-4 border border-gray-100 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors"
                    >
                      <div className="flex items-center gap-4">
          ...
          <TabsContent value="planning" className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <CardContent className="relative text-white">
                      <p className="text-sm mb-4">
                        Gere planos de tratamento personalizados e receba
                        sugestões de atividades com a ajuda da IA.
                      </p>
                      <div className="space-y-3">
                        <Button
                          variant="secondary"
                          className="w-full justify-start bg-white/20 hover:bg-white/30 text-white border-white/40"
                        >
                          <PlusCircle className="h-4 w-4 mr-2" />
                ...
                <Card className="bg-white dark:bg-gray-800 overflow-hidden border-0 shadow-md">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <Button
                        variant="outline"
                        className="w-full justify-start group transition-all duration-200 border-blue-100 dark:border-blue-900/50"
                      >
                      ...
                      <Button
                        variant="outline"
                        className="w-full justify-start group transition-all duration-200 border-teal-100 dark:border-teal-900/50"
                      >
                      ...
                      <Button
                        variant="outline"
                        className="w-full justify-start group transition-all duration-200 border-indigo-100 dark:border-indigo-900/50"
                      >
            ...
            <Card className="bg-white dark:bg-gray-800 overflow-hidden border-0 shadow-md">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-3 rounded-lg bg-gradient-to-r from-green-50 to-transparent dark:from-green-900/10 dark:to-transparent hover:bg-green-50/70 dark:hover:bg-green-900/20 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Plano para Maria Silva atualizado com novos exercícios
                        para fonema R
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 rounded-lg bg-gradient-to-r from-blue-50 to-transparent dark:from-blue-900/10 dark:to-transparent hover:bg-blue-50/70 dark:hover:bg-blue-900/20 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Nova sessão agendada com Pedro Santos para amanhã às
                        15:00
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 rounded-lg bg-gradient-to-r from-teal-50 to-transparent dark:from-teal-900/10 dark:to-transparent hover:bg-teal-50/70 dark:hover:bg-teal-900/20 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Ana Oliveira completou sessão com 90% de acertos nos
                        exercícios
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 rounded-lg bg-gradient-to-r from-amber-50 to-transparent dark:from-amber-900/10 dark:to-transparent hover:bg-amber-50/70 dark:hover:bg-amber-900/20 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Plano de tratamento criado para Lucas Costa com foco nos
                        fonemas F e V
                      </p>
                    </div>
                  </div>
              ...
              <CardFooter className="pt-0">
                <Button
                  variant="outline"
                  className="w-full hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent dark:hover:from-blue-900/10 dark:hover:to-transparent transition-colors"
                >
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col items-center text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Acompanhamento detalhado do desenvolvimento do paciente
                      com métricas e visualizações intuitivas.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Exercícios que se ajustam automaticamente ao nível e
                      progresso do paciente para um aprendizado otimizado.
                    </p>
                  </div>
                </div>
              </CardContent>
