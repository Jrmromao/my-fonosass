...
import { Shield, Users, Database, Lock, Eye, Trash2, Download, Edit, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white">Controlador dos Dados</h4>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  <strong>E-mail:</strong> privacidade@almanaquedafala.com.br<br />
          ...
          <CardContent>
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
              <p className="text-gray-800 dark:text-gray-200">
                <strong>Nome:</strong> Dr. Carlos Silva<br />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Dados de Identificação</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Nome completo, e-mail, telefone, CPF (quando necessário)
                  </p>
                  <Badge variant="secondary" className="mt-2">Consentimento + Contrato</Badge>
                </div>
                
                <div className="border-l-4 border-green-500 pl-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Dados Profissionais</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Título profissional, especialidade, registro no CFFa
                  </p>
                  <Badge variant="secondary" className="mt-2">Execução de Contrato</Badge>
                </div>
              </div>
              
              <div className="space-y-4">
                <div className="border-l-4 border-red-500 pl-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Dados de Pacientes</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Nome, data de nascimento, histórico médico, dados de saúde
                  </p>
                  <Badge variant="destructive" className="mt-2">Consentimento Específico</Badge>
                </div>
                
                <div className="border-l-4 border-yellow-500 pl-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Dados de Navegação</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Endereço IP, cookies, logs de acesso, dados de uso
                  </p>
                  <Badge variant="outline" className="mt-2">Legítimo Interesse</Badge>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <div className="text-center text-sm text-gray-500 dark:text-gray-400 mt-8">
          <p>
            Esta Política de Privacidade foi elaborada em conformidade com a Lei Geral de Proteção de Dados (Lei 13.709/2018).
          </p>
          <p className="mt-2">
