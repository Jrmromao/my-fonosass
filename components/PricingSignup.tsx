    ...
    features: [
      {
        ...
        tooltip:
          'Gerenciamento simplificado para sua base inicial de pacientes',
      },
      {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Você tem acesso completo a todas as funcionalidades durante o período de teste, sem compromisso.',
  },
  {
    question: 'Preciso fornecer cartão de crédito?',
    answer:
      'Não é necessário cartão de crédito para começar seu período de teste gratuito.',
  },
];
    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Escolha o plano ideal para o seu momento profissional. Todos incluem
      ...
      <div className="mt-16 text-center">
        ...
        <div className="max-w-2xl mx-auto p-6 bg-indigo-50 rounded-2xl">
          ...
          <p className="text-gray-600 mb-4">
            Nossa equipe está pronta para criar uma solução sob medida para suas
            necessidades
          </p>
          <Button
            variant="outline"
