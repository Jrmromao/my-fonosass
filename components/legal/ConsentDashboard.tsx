...
export default function ConsentDashboard({ className }: ConsentDashboardProps) {
  ...
  const getConsentStatus = (record: any) => {
    if (!record.granted)
      return { status: 'withdrawn', color: 'destructive', icon: XCircle };
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {record.granted && !record.expiresAt && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleWithdrawConsent(record.consentType)
                            }
                          >
        ...
        <TabsContent value="retention" className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Política de Retenção de Dados:</strong> Seus dados são
              mantidos apenas pelo tempo necessário para cumprir os propósitos
              para os quais foram coletados, conforme estabelecido pela LGPD.
            </AlertDescription>
          </Alert>
