...
export default function EnhancedConsentManager({ 
  ...
  const handlePreferenceChange = async (key: keyof ConsentPreferences, value: boolean) => {
    ...
    if (user?.id) {
      ...
      try {
        ...
        toast({
          ...
          description: "Suas preferências de consentimento foram atualizadas com sucesso.",
        });
      } catch (error) {
  ...
  const consentTypes = [
    {
      ...
      dataCategories: ['Dados pessoais', 'Informações de contato', 'Dados de uso'],
      thirdParties: [],
    ...
    },
    {
      ...
      description: 'Envio de newsletters, ofertas e atualizações sobre nossos serviços.',
      icon: Mail,
      color: 'text-blue-600',
    ...
    },
    {
      ...
      description: 'Coleta de dados para melhorar nossos serviços e experiência do usuário.',
      icon: BarChart3,
    ...
    },
    {
      ...
      description: 'Compartilhamento de dados com provedores de serviços essenciais.',
      icon: Share2,
    ...
    },
    {
      ...
      description: 'Criação de perfis de usuário para personalização de conteúdo.',
      icon: Brain,
      color: 'text-indigo-600',
      bgColor: 'bg-indigo-50 dark:bg-indigo-900/20',
      required: false,
      legalBasis: 'Consentimento',
      dataCategories: ['Dados comportamentais', 'Preferências', 'Padrões de uso'],
      thirdParties: [],
      retentionPeriod: '3 anos'
    },
    {
      ...
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <CardHeader>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Gerencie suas preferências de consentimento de acordo com a Lei Geral de Proteção de Dados (LGPD).
          </p>
        </CardHeader>
                        ...
                        {showDetails[type.key] && (
                          <div className="mt-3 p-3 bg-white dark:bg-gray-800 rounded border">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                              <div>
                                <strong>Base Legal:</strong> {type.legalBasis}
                              </div>
                              <div>
                                <strong>Período de Retenção:</strong> {type.retentionPeriod}
                              </div>
                              <div>
                                <strong>Categorias de Dados:</strong>
                                <ul className="list-disc list-inside mt-1">
                                  {type.dataCategories.map((category, idx) => (
                            ...
                            {isGranted && !type.required && (
                              <Button
                                variant="destructive"
                                size="sm"
                                onClick={() => handleWithdrawConsent(type.key.toUpperCase())}
                                disabled={isLoading}
                                className="mt-3"
                              >
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <ul className="mt-2 space-y-1 text-sm">
                <li>• Consentimentos obrigatórios são necessários para o funcionamento do serviço</li>
                <li>• Você pode alterar suas preferências a qualquer momento</li>
                <li>• Retirar consentimentos pode afetar a funcionalidade do site</li>
                <li>• Todas as alterações são registradas para fins de auditoria</li>
