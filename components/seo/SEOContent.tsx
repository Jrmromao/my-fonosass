      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            O <strong>Almanaque da Fala</strong> é o{' '}
            <strong>software para fonoaudiólogo</strong> mais completo do
            Brasil. Nossa plataforma oferece{' '}
            <strong>sistema de fonoaudiologia</strong> integrado com gestão de
            pacientes,
            <strong>prontuário eletrônico fonoaudiologia</strong> e exercícios
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Sistema completo de <strong>gestão clínica fono</strong> com
              agendamentos, prontuários digitais e controle financeiro em
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Biblioteca com centenas de{' '}
              <strong>exercícios fonoaudiológicos online</strong>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              <strong>Prontuário eletrônico fonoaudiologia</strong> com backup
              automático, criptografia e total conformidade com regulamentações
              do CFFa.
            </p>
          </div>
        </div>
