...
export default function AboutSection() {
  return (
    <section
      id="sobre"
      className="py-20 md:py-32 bg-gradient-to-br from-indigo-50 to-purple-50"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">
              Sobre o Almanaque da Fala
            </h2>
            <p className="text-xl text-gray-600">
              Desenvolvido por fonoaudiólogos para fonoaudiólogos, o Almanaque
              da Fala é a solução definitiva para modernizar e expandir sua
              prática clínica.
            </p>
          ...
          <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/50">
              <Button
                variant="outline"
                className="text-white border-white hover:bg-white/20 rounded-full px-6 py-3"
              >
